...
MonoBehaviour:
  ...
  m_OverlayCanvas:
    ...
    m_SaveData: []
    m_OverlaysVisible: 1
  m_EditorWindowInstanceKey: 9865a3bc4bc04f4797c0a9f202342b22
--- !u!114 &12
MonoBehaviour:
  m_ObjectHideFlags: 52
  m_CorrespondingSourceObject: {fileID: 0}
  ...
  m_Enabled: 1
  m_EditorHideFlags: 0
  m_Script: {fileID: 11500000, guid: 3d990fbdc06718b4a9db66b91b6c006d, type: 3}
  m_Name: 
  m_EditorClassIdentifier: 
  m_MinSize: {x: 600, y: 210}
  m_MaxSize: {x: 600, y: 4000}
  m_TitleContent:
    m_Text: Multiplayer PlayMode Tools
    m_Image: {fileID: 0}
    m_Tooltip: 
  m_Pos:
    serializedVersion: 2
...
MonoBehaviour:
  ...
  m_LastProjectPath: E:\Personal projects\Networking Test
  m_LockTracker:
    m_IsLocked: 1
  m_FolderTreeState:
    scrollPos: {x: 0, y: 115}
    m_SelectedIDs: 4a6e0000
    m_LastClickedID: 28234
    m_ExpandedIDs: ffffffff000000001e6e0000
    m_RenameOverlay:
...
MonoBehaviour:
  ...
  m_SceneHierarchy:
    m_TreeViewState:
      ...
      m_SelectedIDs: 
      m_LastClickedID: 0
      m_ExpandedIDs: aeb5ffff74cfffff30d0fffff0d1ffffcce4ffff88e5ffff48e7ffff
      m_RenameOverlay:
        m_UserAcceptedRename: 0
        m_Name: 
        m_OriginalName: 
...
MonoBehaviour:
  ...
  m_Grid:
    ...
    m_gridOpacity: 0.5
  m_Rotation:
    m_Target: {x: -0.11428486, y: 0.8729717, z: -0.24612613, w: -0.40533707}
    speed: 2
    m_Value: {x: -0.114283904, y: 0.87296444, z: -0.24612407, w: -0.4053337}
  m_Size:
    m_Target: 4.4264493
    speed: 2
    m_Value: 4.4264493
...
MonoBehaviour:
  ...
  m_ZoomArea:
    ...
    m_MinimalGUI: 1
  m_defaultScale: 1
  m_LastWindowPixelSize: {x: 1894, y: 1278}
  m_ClearInEditMode: 1
  m_NoCameraWarning: 1
